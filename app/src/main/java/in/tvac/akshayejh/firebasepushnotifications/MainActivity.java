...
public class MainActivity extends AppCompatActivity {
    ...
    private MainPagerViewAdapter mMainPagerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMainPagerViewAdapter = new MainPagerViewAdapter(getSupportFragmentManager());
        mMainPager.setAdapter(mMainPagerViewAdapter);
